  ...
  const journeyOptions = [
    {
      ...
      title: "Option 1 : Be a Co-Builder",
      ...
      result: "Certified Co Builder + Verified Badge",
    },
    {
      type: "idea_ptc" as JourneyType,
      title: "Option 2 : Be an Initiator",
  ...
  return (
    <div className="space-y-8">
        ...
        <>
          <div className="text-center mb-8">
            <h2 className="font-display text-2xl font-bold text-foreground mb-2">
              Path 2 : Scale Through an idea [Venture Promise]
            </h2>
      ...
      {showScalingPath && !scalingCompleted && (
        <Card className="relative overflow-hidden transition-all hover:shadow-lg border-b4-purple/30 mt-8">
          <CardHeader className="pb-4">
            <div className="flex items-start justify-between">
