...
import { ClipboardList, Loader2, Users, Lightbulb, TrendingUp } from "lucide-react";
          ...
          <main className="pt-20">
            <section className="py-16">
              <div className="container mx-auto px-4 text-center">
                <h1 className="font-display text-3xl font-bold text-foreground mb-4">Check List</h1>
                <p className="text-muted-foreground mb-8">Please log in to access your check list.</p>
              </div>
            </section>
          </main>
        </PageTransition>
          ...
          <section className="py-12 gradient-hero text-primary-foreground">
            <div className="container mx-auto px-4">
              <div className="flex items-center gap-3 mb-2">
                ...
                <h1 className="font-display text-3xl font-bold">Check List</h1>
              </div>
