                ...
                <div key={path.key}>
                  ...
                  <div className="space-y-4">
                    {path.favSteps.map((step) => (
                      ...
                      >
                        <div className={`w-11 h-11 rounded-xl bg-gradient-to-br ${path.gradient} flex items-center justify-center text-primary-foreground font-bold text-base shrink-0`}>
                          {step.number}
                        </div>
